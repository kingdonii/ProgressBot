...
.setTitle('Commands')
.addFields(
    { name: '!stopped', value: 'Marks the date at which you stopped' },
    { name: '!stoppedfor', value: `Specifies how many days you've stopped in (example : !stoppedxfor 15 days)` },
    { name: '!progress', value: `Shows you how long you've been going so far!`},
    { name: '!did', value: 'Resets your progress to today' },
    { name: '!reset', value: 'Deletes your progress entirely' },
);
...
return message.reply(`Congratulations on stopping for ` + didntdays + ` days!`);
}
  }
if (command === 'did') {
